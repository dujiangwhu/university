...
public class PathFormat {
	...
	/**
	 * 石华增加，用于从session中获取当前登录人的机构，生成文件路径
	 * 2015-11-26
	 */
	...
	public static String parse (String orgid, String input, String filename ) {
		...
		while ( matcher.find() ) {
			...
			}else if(matchStr.indexOf( PathFormat.ORGID ) != -1){
				/**
				 * 石华增加，在问加你存储路径中替换机构id
				 * 2015-11-26
				 */
				matcher.appendReplacement(sb, orgid );
			} else {
