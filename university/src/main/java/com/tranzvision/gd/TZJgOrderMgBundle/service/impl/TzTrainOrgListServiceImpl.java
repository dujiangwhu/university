 ...
 * @since 2015-11-06
 */
@Service("com.tranzvision.gd.TZJgOrderMgBundle.service.impl.TzTrainOrgListServiceImpl")
public class TzTrainOrgListServiceImpl extends FrameworkImpl {
	...
	public String tzQueryList(String strParams, int numLimit, int numStart, String[] errorMsg) {
		...
		try {
			...
			// json数据要的结果字段;
			String[] resultFldArray = { "TZ_JG_ID", "TZ_JG_NAME", "TZ_ORGAN_CONTACT","TZ_ORGAN_CONTACTPH","TZ_JG_TIMECARD_YY","TZ_JG_TIMECARD_SY" };
			...
			if (obj != null && obj.length > 0) {
				...
				for (int i = 0; i < list.size(); i++) {
					...
					mapList.put("orgTimeCardHave", rowList[4]);
					mapList.put("orgTimeCardAssign", rowList[5]);
