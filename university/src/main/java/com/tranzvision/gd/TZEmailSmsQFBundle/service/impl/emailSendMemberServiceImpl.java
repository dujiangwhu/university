 ...
 * 
 */
@Service("com.tranzvision.gd.TZEmailSmsQFBundle.service.impl.emailSendMemberServiceImpl")
public class emailSendMemberServiceImpl extends FrameworkImpl{
	@Autowired
	...
	public String tzQueryList(String comParams, int numLimit, int numStart, String[] errorMsg) {
		...
		try {
			...
			// json数据要的结果字段;
			String[] resultFldArray = { "TZ_EML_SMS_TASK_ID", "TZ_RWSL_ID", "TZ_AUD_XM", "TZ_JS_EMAIL", "TZ_FSSJ_DT", "TZ_FS_ZTMS"};
