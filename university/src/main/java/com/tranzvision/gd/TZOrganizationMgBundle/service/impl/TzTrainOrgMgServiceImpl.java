 ...
 * @since 2015-11-06
 */
@Service("com.tranzvision.gd.TZOrganizationMgBundle.service.impl.TzTrainOrgMgServiceImpl")
public class TzTrainOrgMgServiceImpl extends FrameworkImpl {
		...
		try {
			...
			if (jacksonUtil.containsKey("orgId")) {
				...
				if (psTzJgBaseT != null) {
					...
					mapOrg.put("orgAuditStatus", psTzJgBaseT.getTzJgAuditSta());
					...
					mapOrg.put("orgLxrQQ", psTzJgBaseT.getTzOrganContactqq());
					...
					mapOrg.put("orgTimeCardHave", psTzJgBaseT.getTzJgTimecardYy()==null?"0":psTzJgBaseT.getTzJgTimecardYy());
					mapOrg.put("orgTimeCardAssign", psTzJgBaseT.getTzJgTimecardSy()==null?"0":psTzJgBaseT.getTzJgTimecardSy());
					mapOrg.put("orgIntro", psTzJgBaseT.getTzJgIntro());
