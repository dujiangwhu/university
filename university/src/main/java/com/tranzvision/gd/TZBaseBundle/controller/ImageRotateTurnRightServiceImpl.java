...
public class ImageRotateTurnRightServiceImpl {

	@RequestMapping(value = "ImageRotateTurnRight", method = RequestMethod.POST, produces = "text/html;charset=UTF-8")
		...
		try {
			...
			for (int i = 0; i < width; i++){
				for (int j = 0; j < height; j++){
					biFlip.setRGB(height - 1 - j, i, bufferedImg.getRGB(i, j));
				}
			}
