...
public class TzWxJSSDKSign {
	...
	public TzWxJSSDKSign(){
		...
		getSysHardCodeVal = (GetSysHardCodeVal) getSpringBeanUtil.getAutowiredSpringBean("GetSysHardCodeVal");
		getHardCodePoint = (GetHardCodePoint) getSpringBeanUtil.getAutowiredSpringBean("GetHardCodePoint");
		psTzWxGzhcsTMapper = (PsTzWxGzhcsTMapper) getSpringBeanUtil.getAutowiredSpringBean("PsTzWxGzhcsTMapper");
	}
