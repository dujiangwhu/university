Ext.define('KitchenSink.view.enrollmentManagement.bmb_lcpi.studentsList', {
    extend: 'Ext.panel.Panel',
    xtype: 'studentsListpi',
    ...
    requires: [
        ...
        'KitchenSink.view.enrollmentManagement.bmb_lcpi.studentsStore',
