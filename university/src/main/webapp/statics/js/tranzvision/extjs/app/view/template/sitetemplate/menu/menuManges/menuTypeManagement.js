Ext.define('KitchenSink.view.template.sitetemplate.menu.menuManges.menuTypeManagement', {
	...
	requires: [
        ...
        'KitchenSink.view.template.sitetemplate.menu.menuManges.menuController',//调用控制器
		'KitchenSink.view.template.sitetemplate.menu.menuManges.menuTypeModel',//json格式
        'KitchenSink.view.template.sitetemplate.menu.menuManges.menuTypeStore'//json路径
    ],
    xtype: 'menuTypeManagement',
	controller: 'menuTypeInfo',
	siteId:'',
	store: {
        type: 'menuTypeStore'
    },
