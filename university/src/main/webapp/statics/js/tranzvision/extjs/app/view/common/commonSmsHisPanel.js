Ext.define('KitchenSink.view.common.commonSmsHisPanel', {
  extend: 'Ext.grid.Panel',
	requires: [
        ...
        'KitchenSink.view.common.store.commonSmsHisStore'
  ],
  xtype: 'commonSmsHis',
  columnLines: true,
	style:"margin:8px",
  ...
  dockedItems:[
  	{
			...
			items:['->',
			{
				minWidth:80,text:"关闭",iconCls:"close",handler: function(btn){
								//获取窗口
								var win = btn.findParentByType("commonSmsHis");
								//关闭窗口
								win.close();
				}
			}]
	...
	initComponent: function () {   
    		var me = this;  										
    		var store = new KitchenSink.view.common.store.commonSmsHisStore(me.tmpId);	
