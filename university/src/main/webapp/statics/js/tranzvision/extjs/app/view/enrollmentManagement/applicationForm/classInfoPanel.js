                ...
                items: [{
                    ...
                    dockedItems:{
                        ...
                        items:[
                            ...
                            {
                                text:Ext.tzGetResourse("TZ_BMGL_BMBSH_COM.TZ_BMGL_STU_STD.downloadPhoto","将选中人员照片批量下载"),
                                iconCls:"zip",
                                handler:"pakAndDownPhoto"
                            },'-',
                            {
                            ...
                            ,'->',
                            {
                                ...
                                menu:[  {
                                    ...
                                    text:Ext.tzGetResourse("TZ_BMGL_BMBSH_COM.TZ_BMGL_STU_STD.setBatchSelectedPerson","给选中人设置批次"),
                                    handler:'setBatchSelPers'
                                },{
                                    text:Ext.tzGetResourse("TZ_BMGL_BMBSH_COM.TZ_BMGL_STU_STD.setBatchSearchPerson","给搜索结果的人全部设置批次"),
                                    handler:'setBatchSelPersOfAll'
                                },{
                                    text:Ext.tzGetResourse("TZ_BMGL_BMBSH_COM.TZ_BMGL_STU_STD.cldbAlloa","搜索结果材料批量打包"),
                                    iconCls:"zip",
                                    handler:'packageAndDownloadOfAll'
                                },{
                                    text:Ext.tzGetResourse("TZ_BMGL_BMBSH_COM.TZ_BMGL_STU_STD.tjxdbAlloa","搜索结果推荐信批量打包"),
                                    iconCls:"zip",
                                    handler:'packageTjxDownloadOfAll'
                                },{
                                    text:Ext.tzGetResourse("TZ_BMGL_BMBSH_COM.TZ_BMGL_STU_STD.dcExcelAlloa","导出搜索结果信息到Excel"),
                                    iconCls:"excel",
                            ...
                            columns:[
                                {
                                    ...
                                    text: Ext.tzGetResourse("TZ_BMGL_BMBSH_COM.TZ_BMGL_STU_COM.applyBatch","申请批次"),
                                    dataIndex: 'batchName',
                                    width:100,
                                    lockable   : false,
                                    filter: {
                                 ...
                                 return "";
                                    ...
                                    text: Ext.tzGetResourse("TZ_BMGL_BMBSH_COM.TZ_BMGL_STU_COM.interviewBatch2","面试批次"),
