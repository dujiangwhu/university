Ext.define('KitchenSink.view.bulkEmailAndSMS.emailBulk.viewHistoryEmail.emailSendMemberWindow', {
    extend: 'Ext.window.Window',
    xtype: 'emailSendMemberWindow',
    requires: [
        'Ext.data.*',
        'Ext.grid.*',
        'Ext.util.*',
        ...
        'KitchenSink.view.bulkEmailAndSMS.emailBulk.viewHistoryEmail.emailSendMemberStore'
    ],
    title: '',
    layout: 'fit',
    ...
    initComponent: function(){
		var me = this;
		var store = new KitchenSink.view.bulkEmailAndSMS.emailBulk.viewHistoryEmail.emailSendMemberStore({
				taskId: this.taskId,
		...
		var columns = [{
					...
					text: Ext.tzGetResourse("TZ_COMMON_EMAIL_COM.TZ_SEND_MEMBER_STD.email","邮箱"),
					dataIndex: 'email',
					minWidth: 120,                
					flex: 1	
				},{
            ...
            items: [{
				...
				dockedItems:[{
					...
					items:['->',
						...
						{   var win = btn.findParentByType("emailSendMemberWindow");
							win.close();
						}}]
					},
	...
	searchEmlMember: function(btn){
		var win = btn.findParentByType('emailSendMemberWindow');
		Ext.tzShowCFGSearch({            
           cfgSrhId: 'TZ_EMLQ_VIEWTY_COM.TZ_EMLQ_MEMBER_STD.TZ_EMLHIS_RY_V',
           condition:
            {
	...
	onViewRz: function(grid,rowIndex,colIndex){
		...
		var tzParams = '{"ComID":"TZ_EMLQ_VIEWTY_COM","PageID":"TZ_EMLQ_MEMBER_STD","OperateType":"QF","comParams":{"taskId":"'+ taskId +'","rwInsId":"'+ rwInsId +'"}}';
