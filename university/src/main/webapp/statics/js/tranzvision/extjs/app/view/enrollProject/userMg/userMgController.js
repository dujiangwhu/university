Ext.define('KitchenSink.view.enrollProject.userMg.userMgController', {
    ...
    //查询
    querySite:function(btn){
		Ext.tzShowCFGSearch({
			cfgSrhId: 'TZ_UM_USERMG_COM.TZ_UM_USER_STD.TZ_WEBSIT_SET_VW',
			condition:
            {
                "TZ_JG_ID": Ext.tzOrgID
            }, 
    ...
    viewSiteUser:function(grid,html,rowIndex,colIndex,table,record){
          ...
          var pageResSet = TranzvisionMeikecityAdvanced.Boot.comRegResourseSet["TZ_UM_USERMG_COM"]["TZ_UM_USERMG_STD"];
          if( pageResSet == "" || pageResSet == undefined){
    	...
    	var ViewClass =Ext.ClassManager.get('KitchenSink.view.enrollProject.userMg.userMgList');
 			...
 			var store = panel.getStore();
 	        	...
 	        	var tzStoreParams = {
 	            		...
 	            		"condition":{
 	            			...
 	            			"TZ_SITEI_ID-operator": "01",
 	            			"TZ_SITEI_ID-value":siteID
 	            				}
 	            };
