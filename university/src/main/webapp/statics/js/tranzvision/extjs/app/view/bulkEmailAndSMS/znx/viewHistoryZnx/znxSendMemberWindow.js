Ext.define('KitchenSink.view.bulkEmailAndSMS.znx.viewHistoryZnx.znxSendMemberWindow', {
    extend: 'Ext.window.Window',
    xtype: 'znxSendMemberWindow',
    requires: [
        'Ext.data.*',
        'Ext.grid.*',
        'Ext.util.*',
        ...
        'KitchenSink.view.bulkEmailAndSMS.znx.viewHistoryZnx.znxSendMemberStore'
    ],
    title: '',
    layout: 'fit',
    ...
    initComponent: function(){
		var me = this;
		var store = new KitchenSink.view.bulkEmailAndSMS.znx.viewHistoryZnx.znxSendMemberStore({
				taskId: this.taskId,
            ...
            items: [{
				...
				dockedItems:[{
					...
					items:['->',
						...
						{   var win = btn.findParentByType("znxSendMemberWindow");
							win.close();
						}}]
					},
	...
	searchEmlMember: function(btn){
		var win = btn.findParentByType('znxSendMemberWindow');
		Ext.tzShowCFGSearch({            
           cfgSrhId: 'TZ_ZNXQ_VIEWTY_COM.TZ_ZNXQ_MEMBER_STD.TZ_ZNXHIS_RY_V',
           condition:
            {
	...
	onViewRz: function(grid,rowIndex,colIndex){
		...
		var tzParams = '{"ComID":"TZ_ZNXQ_VIEWTY_COM","PageID":"TZ_ZNXQ_MEMBER_STD","OperateType":"QF","comParams":{"taskId":"'+ taskId +'","rwInsId":"'+ rwInsId +'"}}';
