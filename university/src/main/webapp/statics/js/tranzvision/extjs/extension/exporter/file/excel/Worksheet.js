 ...
 */
Ext.define('tranzvision.extension.exporter.file.excel.Worksheet', {
    ...
    config: {
        ...
        showGridLines:  true,
        /**
         * @cfg {tranzvision.extension.exporter.file.excel.Table[]} tables
         *
    ...
    applyTables: function(data, dataCollection){
        return this.checkCollection(data, dataCollection, 'tranzvision.extension.exporter.file.excel.Table');
    },

    /**
     * Convenience method to add tables. You can also use workbook.getTables().add(config).
     * @param {Object/Array} config
     * @return {tranzvision.extension.exporter.file.excel.Table/tranzvision.extension.exporter.file.excel.Table[]}
     */
     ...
     * @param id
     * @return {tranzvision.extension.exporter.file.excel.Table}
     */
