 ...
 */
Ext.define('tranzvision.extension.exporter.file.excel.Row', {
    ...
    config: {
        ...
        caption: null,
        /**
         * @cfg {tranzvision.extension.exporter.file.excel.Cell[]} cells
         *
    ...
    applyCells: function(data, dataCollection){
        return this.checkCollection(data, dataCollection, 'tranzvision.extension.exporter.file.excel.Cell');
    },

    /**
     * Convenience method to add cells. You can also use workbook.getCells().add(config).
     * @param {Object/Array} config
     * @return {tranzvision.extension.exporter.file.excel.Cell/tranzvision.extension.exporter.file.excel.Cell[]}
     */
     ...
     * @param id
     * @return {tranzvision.extension.exporter.file.excel.Cell}
     */
    getCell: function(id){
