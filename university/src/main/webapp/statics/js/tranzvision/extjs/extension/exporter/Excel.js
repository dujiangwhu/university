 ...
 */
Ext.define('tranzvision.extension.exporter.Excel', {
    extend: 'tranzvision.extension.exporter.Base',

    alias:  'exporter.excel',

    requires: [
        'tranzvision.extension.exporter.file.excel.Workbook'
    ],
    ...
    config: {
        ...
        /**
         * @cfg {tranzvision.extension.exporter.file.excel.Style} defaultStyle
         *
        ...
        /**
         * @cfg {tranzvision.extension.exporter.file.excel.Style} titleStyle
         *
        ...
        /**
         * @cfg {tranzvision.extension.exporter.file.excel.Style} groupHeaderStyle
         *
        ...
        /**
         * @cfg {tranzvision.extension.exporter.file.excel.Style} groupFooterStyle
         *
        ...
        /**
         * @cfg {tranzvision.extension.exporter.file.excel.Style} tableHeaderStyle
         *
    ...
    getContent: function(){
        ...
        me.workbook = Ext.create('tranzvision.extension.exporter.file.excel.Workbook',{
            title:              config.title,
