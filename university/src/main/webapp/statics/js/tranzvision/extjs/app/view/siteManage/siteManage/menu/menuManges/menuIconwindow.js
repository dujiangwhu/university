Ext.define('KitchenSink.view.siteManage.siteManage.menu.menuManges.menuIconwindow', {
    extend: 'Ext.window.Window',
    xtype: 'menuIconwindow', 
	controller: 'menuIconController',
	requires: [
       'KitchenSink.view.siteManage.siteManage.menu.menuManges.menuIconController'
    ],
    title: '菜单类型图标设置', 
