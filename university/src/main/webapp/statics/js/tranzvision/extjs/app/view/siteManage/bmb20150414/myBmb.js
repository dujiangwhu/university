Ext.define('KitchenSink.view.template.bmb.myBmb', {
    ...
    dockedItems:[{
		xtype:"toolbar",
		items:[
			{text:"新增",tooltip:"新增模板",iconCls:"add",handler:'addBmbTpl'}
		]
	}],
    initComponent: function () {    
        Ext.apply(this, {
            columns: [{ 
			   ...
			   width:60,
               xtype: 'actioncolumn',
			   items:[{iconCls: 'edit',tooltip: '编辑',handler:'editBmbTpl'},
					  {iconCls: 'edit',tooltip: '复制',handler:'copyBmbTpl'},
					  {iconCls: 'edit',tooltip: '预览',handler:'previewBmbTpl'}
			   ]
            }],
            bbar: {
                xtype: 'pagingtoolbar',
