Ext.define('KitchenSink.view.siteManage.siteManage.area.typeManges.areaTypeManagement', {
	...
	requires: [
        ...
        'KitchenSink.view.siteManage.siteManage.area.typeManges.areaController',//调用控制器
		'KitchenSink.view.siteManage.siteManage.area.typeManges.areaTypeModel',//json格式
        'KitchenSink.view.siteManage.siteManage.area.typeManges.areaTypeStore'//json路径
    ],
