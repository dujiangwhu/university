Ext.define('KitchenSink.view.batch.circulate.batchCirculateDefnMngController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.batchCirculateDefnMngController', 
    addBatchCirculateDefnInfo: function() {
		//是否有访问权限
		var pageResSet = TranzvisionMeikecityAdvanced.Boot.comRegResourseSet["TZ_BATCH_XH_COM"]["TZ_BATCH_XHDFN_STD"];
		...
		if(className == "" || className == undefined){
			Ext.MessageBox.alert('提示', '未找到该功能页面对应的JS类，页面ID为：TZ_BATCH_XHDFN_STD，请检查配置。');
			return;
		}
	...
	searchBatchCirculateDefnList: function(btn){
		Ext.tzShowCFGSearch({
			cfgSrhId: 'TZ_BATCH_XH_COM.TZ_BATCH_XHMNG_STD.TZ_XUNH_DEFN_T',
	...
	closeBatchCirculateDefnMng: function(btn){
		//关闭
		var grid = btn.findParentByType("grid");
		grid.close();
	},
