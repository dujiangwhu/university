 ...
 *
 */
Ext.define('tranzvision.extension.exporter.Base', {
    mixins: [
    ...
    requires: [
        'tranzvision.extension.exporter.File'
    ],
     ...
     */
    saveAs: function(){
        tranzvision.extension.exporter.File.saveAs(this.getContent(), this.getFileName(), this.getCharset());
    },
