Ext.define('KitchenSink.view.trainStudentMg.trainStudentList', {
    extend: 'Ext.panel.Panel',
    xtype: 'trainStudentList',
    ...
    listeners:{
        afterrender: function(panel){
            ...
            var tzParams = '{"ComID":"TZ_PX_STU_COM","PageID":"TZ_PX_STU_STD","OperateType":"QF","comParams":{"ORGID":"'+panel.orgId+'"}}';
