Ext.define('KitchenSink.view.siteManage.siteManage.column.siteLMController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.siteLMInfoI', 
	onFormSave: function(btn){
		...
		//提交参数
		var tzParams = '{"ComID":"TZ_GD_ZDGL_COM","PageID":"TZ_GD_ZDLM_STD","OperateType":"U","comParams":{'+comParams+'}}';
