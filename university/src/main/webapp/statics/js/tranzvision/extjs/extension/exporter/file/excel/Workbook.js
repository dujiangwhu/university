 ...
 *
 *      var workbook = Ext.create('tranzvision.extension.exporter.file.excel.Workbook', {
 *              title:  'My document',
 *              author: 'John Doe'
 *          }),
 ...
 *
 */
Ext.define('tranzvision.extension.exporter.file.excel.Workbook', {
    extend: 'tranzvision.extension.exporter.file.Base',

    requires: [
        'tranzvision.extension.exporter.file.excel.Worksheet',
        'tranzvision.extension.exporter.file.excel.Table',
        'tranzvision.extension.exporter.file.excel.Style',
        'tranzvision.extension.exporter.file.excel.Row',
        'tranzvision.extension.exporter.file.excel.Column',
        'tranzvision.extension.exporter.file.excel.Cell'
    ],
    ...
    config: {
        ...
        /**
         * @cfg {String} [protectStructure='False']
         *
         * Protect structure
         */
        ...
        /**
         * @cfg {String} [protectWindows='False']
         *
         * Protect windows
         */
        ...
        /**
         * @cfg {tranzvision.extension.exporter.file.excel.Style[]} styles
         *
        ...
        /**
         * @cfg {tranzvision.extension.exporter.file.excel.Worksheet[]} worksheets
         *
    ...
    applyStyles: function(data, dataCollection){
        return this.checkCollection(data, dataCollection, 'tranzvision.extension.exporter.file.excel.Style');
    },

    applyWorksheets: function(data, dataCollection){
        return this.checkCollection(data, dataCollection, 'tranzvision.extension.exporter.file.excel.Worksheet');
    },

    /**
     * Convenience method to add styles. You can also use workbook.getStyles().add(config).
     * @param {Object/Array} config
     * @returns {tranzvision.extension.exporter.file.excel.Style/tranzvision.extension.exporter.file.excel.Style[]}
     */
     ...
     * @param id
     * @returns {tranzvision.extension.exporter.file.excel.Style}
     */
     ...
     * @param {Object/Array} config
     * @returns {tranzvision.extension.exporter.file.excel.Worksheet/tranzvision.extension.exporter.file.excel.Worksheet[]}
     */
     ...
     * @param id
     * @returns {tranzvision.extension.exporter.file.excel.Worksheet}
     */
