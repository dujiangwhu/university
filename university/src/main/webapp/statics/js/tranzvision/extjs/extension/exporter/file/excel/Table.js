 ...
 */
Ext.define('tranzvision.extension.exporter.file.excel.Table', {
    ...
    config: {
        ...
        topCell: 1,
        /**
         * @cfg {tranzvision.extension.exporter.file.excel.Column[]} columns
         *
         * Collection of column definitions available on this table
         */
        columns: [],
        /**
         * @cfg {tranzvision.extension.exporter.file.excel.Row[]} rows
         *
    ...
    applyColumns: function(data, dataCollection){
        return this.checkCollection(data, dataCollection, 'tranzvision.extension.exporter.file.excel.Column');
    },

    applyRows: function(data, dataCollection){
        return this.checkCollection(data, dataCollection, 'tranzvision.extension.exporter.file.excel.Row');
    },

    /**
     * Convenience method to add columns. You can also use workbook.getColumns().add(config).
     * @param {Object/Array} config
     * @return {tranzvision.extension.exporter.file.excel.Column/tranzvision.extension.exporter.file.excel.Column[]}
     */
     ...
     * @param id
     * @return {tranzvision.extension.exporter.file.excel.Column}
     */
     ...
     * @param {Object/Array} config
     * @return {tranzvision.extension.exporter.file.excel.Row/tranzvision.extension.exporter.file.excel.Row[]}
     */
     ...
     * @param id
     * @return {tranzvision.extension.exporter.file.excel.Row}
     */
    getRow: function(id){
