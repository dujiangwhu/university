...
delete from PS_TZ_SITEI_AREA_T where TZ_SITEI_ID in (
	select TZ_SITEI_ID from PS_TZ_SITEI_DEFN_T where TZ_JG_ID in (select TZ_JG_ID from PS_TZ_JG_BASE_T where TZ_JG_ID<>'ADMIN')
);
...
/*站点实例表*/
delete from PS_TZ_SITEI_DEFN_T where TZ_JG_ID in (select TZ_JG_ID from PS_TZ_JG_BASE_T where TZ_JG_ID<>'ADMIN');